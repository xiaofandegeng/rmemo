...
- 发布状态：`v1.3.0` 已发布（包含 v1.1 周期核心成果与后续稳定性迭代）。
...
- [x] 发布 `v1.1.0`，完成 GitHub Release 与 npm 双端可见性校验（后续已迭代至 `v1.3.0`）。
...
1. 完成文档收敛与发布演练。
2. 发布 `v1.1.0` 并补齐 release notes 模板（已完成，后续已发布 `v1.3.0`）。
