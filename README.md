...
- `npm run verify:release-archive-find -- --version <version> --require-files release-ready.json,release-health.json,release-rehearsal.json,release-summary.json --format json` (validate latest snapshot completeness)
