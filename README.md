...
- `release-summary.json` includes archive status details (`archive.snapshotId`, `archive.archiveStep`, `archive.verify`), and `archive.verify.requiredFilesPreset` when preset-based verification is used
